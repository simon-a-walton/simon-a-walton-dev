        ...
        <div className="row pt-4">
          <div className="col-lg-6 col-md-12 text-center pb-3">
           ...
           <div className={`col-lg-6 col-md-12 pr-4 ${textContent}`}>
            <h2>Coding</h2>
              <p>
                I’m currently working as a Junior Front End Developer at a creative digital agency,
                specialising in HTML, CSS, Boostrap, JQuery, Wordpress and responsive design.
                I am used to quick turnarounds for very strict deadlines. I also work as a freelance developer and have taught
                myself ReactJS.
              </p>
            </div>
          </div>
          <div className="row pt-4">
            <div className={`col-lg-6 col-md-12 order-2 order-sm-1 ${textContent}`}>
             ...
             <div className="col-lg-6 col-md-12 text-center order-1 order-sm-2 pb-3">
              <img
